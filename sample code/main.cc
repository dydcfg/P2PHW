...
/* Callback function of anti-entropy. It will send out status message to a random neighbor */
...
/* Callback function for rumor message timeout */
...
/* Callback funtion for receiving new datagram */
...
/* Send rumor message of origin and idx(seqence number) to rcvPort */
...
/* Send status message to rcvPort */
